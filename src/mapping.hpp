 ...
 */
bool PathIntersect(const Clipper2Lib::PathD& path1, const Clipper2Lib::PathD& path2, double scale = 1e6);
 ...
 * @return True if the paths intersect, false otherwise.
 */
bool PathsIntersect(const Clipper2Lib::PathsD& paths1, const Clipper2Lib::PathsD& paths2, double scale = 1e6);
