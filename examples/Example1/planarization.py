...
print("Path")
print("Path:" + os.path.dirname(os.path.dirname(__file__) + "/planarize.cpython-37m-darwin.so")
so = ctypes.cdll.LoadLibrary(os.path.dirname(os.path.dirname(__file__) + "/planarize.cpython-37m-darwin.so")
